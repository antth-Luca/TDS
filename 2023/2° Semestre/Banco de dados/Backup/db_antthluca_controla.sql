...
CREATE TABLE `controla` (
  `id_controla` int NOT NULL AUTO_INCREMENT,
  `id_depto` int DEFAULT NULL,
  `cod_proj` int DEFAULT NULL,
  PRIMARY KEY (`id_controla`),
  KEY `id_depto` (`id_depto`),
  KEY `cod_proj` (`cod_proj`),
  CONSTRAINT `controla_ibfk_1` FOREIGN KEY (`id_depto`) REFERENCES `departamento` (`id_depto`),
  CONSTRAINT `controla_ibfk_2` FOREIGN KEY (`cod_proj`) REFERENCES `projeto` (`cod_proj`)
